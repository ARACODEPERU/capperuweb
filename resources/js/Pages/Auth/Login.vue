                    ...
                    <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        ...
                        <div class="w-full max-w-[440px] lg:mt-16">
                            ...
                            <div class="relative my-7 text-center md:mb-9">
                                ...
                                <span class="relative bg-white px-2 font-bold uppercase text-white-dark dark:bg-dark dark:text-white-light">Soguenos en</span>
                            </div>
                        ...
                        <p class="absolute bottom-6 w-full text-center dark:text-white">© {{ new Date().getFullYear() }}. <a href="https://www.aracodeperu.com/">ARACODE SMART SOLUTIONS</a> All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
