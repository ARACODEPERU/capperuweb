<div>
    <div data-aos="fade-right" data-aos-duration="1500">
        <div class="movie-list section-padding-lr section-pt-50 modern-themed-section">
    ...
    <style>
        ...
        .coursesSwiper .swiper-pagination-bullet-active {
            background: #ce1212; /* Color de marca */
            opacity: 1;
        }

        [data-bs-theme="dark"] .modern-card-elevation:hover {
            box-shadow: 0 12px 30px rgba(0, 0, 0, 0.6);
            border-color: #ce1212; /* Sutil destello de marca al pasar el mouse */
        }
    </style>
</div>
