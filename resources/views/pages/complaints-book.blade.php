            ...
            <form method="POST" action="{{ route('send_claim') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select class="form-control" id="exampleFormControlSelect1" name="document_type">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="product_type" id="formGroupExampleInput" placeholder="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="formGroupExampleInput">Nombre del producto *</label>
                        <input type="text" class="form-control" name="product_name" id="formGroupExampleInput" placeholder="">
                    </div>
                    <div class="form-group col-md-4">
